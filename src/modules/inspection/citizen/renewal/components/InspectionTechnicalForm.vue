...
<style scoped>
  .technical-form { background: #fff; border: 1px solid #344054; color: #111827; padding: 34px 36px; }.technical-form__header { border-bottom: 1px solid #344054; text-align: center; }.technical-form__header h2 { font-size: 1.15rem; margin: 0 0 6px; }.technical-form__header p { font-size: .95rem; margin: 0 0 15px; }.technical-form__notice { background: #fff8e1; border-left: 3px solid #d97706; font-size: .95rem; margin: 18px 0; padding: 10px 12px; }.technical-form__grid { display: grid; gap: 15px 28px; grid-template-columns: repeat(2, minmax(0, 1fr)); }.technical-form__grid div { border-bottom: 1px dotted #667085; display: flex; flex-direction: column; min-height: 45px; }.technical-form__grid span { color: #667085; font-size: .95rem; }.technical-form__grid strong { font-size: .95rem; margin-top: 3px; overflow-wrap: anywhere; }.technical-form__blank { border: 1px solid #667085; margin-top: 28px; padding: 16px; }.technical-form__blank h3 { font-size: .95rem; margin: 0 0 14px; }.technical-form__blank-grid { display: grid; gap: 22px; grid-template-columns: repeat(2, minmax(0, 1fr)); }.technical-form__blank p { display: flex; font-size: .95rem; gap: 8px; margin: 0; }.technical-form__blank i { border-bottom: 1px dotted #475467; flex: 1; } @media (max-width: 599px) { .technical-form { padding: 24px 18px; }.technical-form__grid, .technical-form__blank-grid { grid-template-columns: 1fr; } }
</style>
